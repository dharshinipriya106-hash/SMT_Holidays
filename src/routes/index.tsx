  ...
  head: () => ({
    meta: [
      ...
      { name: "twitter:card", content: "summary_large_image" },
      {
        name: "keywords",
        content:
          "travel agency Sankarankovil, tour packages Tirunelveli, family tour Tamil Nadu, temple tour packages, Kerala tour, Ooty tour, Kodaikanal tour, Kanyakumari tour, South India tour operator",
      },
    ],
