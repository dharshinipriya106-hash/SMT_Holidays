...
const STEPS = [
  {
    ...
    desc: "Tell us your destination, dates and travelers.",
  },
  {
    icon: FileText,
    title: "Get Custom Quote",
    desc: "Receive a tailored itinerary with transparent pricing.",
  },
  {
    icon: CalendarCheck,
    title: "Confirm Booking",
    desc: "Pay a small advance to lock your dates and hotels.",
  },
  {
    icon: PlaneTakeoff,
    title: "Enjoy Your Trip",
    desc: "Travel comfortably with 24/7 on-trip support.",
  },
];
    ...
    <section id="how" className="section-pad bg-surface">
      <div className="container-pg">
        <div className="text-center max-w-2xl mx-auto">
          ...
          <h2 className="mt-3 text-3xl md:text-4xl font-bold">Plan your trip in 4 simple steps</h2>
