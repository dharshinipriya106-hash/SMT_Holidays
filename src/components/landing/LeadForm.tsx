        ...
        <div className="rounded-3xl overflow-hidden border border-border bg-gradient-to-br from-primary to-primary/80 text-primary-foreground">
          <div className="grid lg:grid-cols-2">
            <div className="p-8 md:p-12 flex flex-col justify-center">
              ...
              <h2 className="mt-3 text-3xl md:text-4xl font-bold">Plan Your Dream Vacation</h2>
              <p className="mt-4 text-primary-foreground/85">
                Tell us where you want to go. We'll send a custom itinerary with transparent pricing
                — usually within an hour.
              </p>
              <ul className="mt-6 space-y-2 text-sm text-primary-foreground/85">
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="h-4 w-4 text-accent" /> No advance to get a quote
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="h-4 w-4 text-accent" /> Flexible dates & group sizes
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="h-4 w-4 text-accent" /> 24/7 WhatsApp support
                </li>
              </ul>
            </div>
              ...
              <form onSubmit={onSubmit} className="space-y-4">
                ...
                {submitted && (
                  <p className="text-sm text-primary flex items-center gap-1.5">
                    <CheckCircle2 className="h-4 w-4" /> Inquiry opened in WhatsApp. We'll respond
                    shortly.
                  </p>
                )}
              </form>
