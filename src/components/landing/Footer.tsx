      ...
      <div className="container-pg py-14 grid gap-10 md:grid-cols-4">
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="font-display text-lg font-bold tracking-tight">SMT Holidays</span>
          </div>
          <p className="mt-4 text-sm text-primary-foreground/75 leading-relaxed">
            Your trusted travel partner in Sankarankovil for family tours, temple tours and
            customized South India holidays.
          </p>
        </div>
        ...
        <div>
          <h4 className="text-sm font-semibold uppercase tracking-wider text-accent">Follow Us</h4>
          <ul className="mt-4 space-y-3 text-sm">
            <li>
              <a
                href={waUrl("Hi SMT Holidays!")}
                target="_blank"
