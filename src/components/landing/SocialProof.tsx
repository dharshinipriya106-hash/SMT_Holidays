        ...
        <div className="flex items-center gap-4">
          <div className="flex h-12 w-12 items-center justify-center rounded-full bg-white border border-border shadow-sm font-bold text-xl">
            <span
              ...
              style={{ backgroundImage: "linear-gradient(45deg,#4285F4,#EA4335,#FBBC05,#34A853)" }}
            >
              G
            </span>
          </div>
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-0.5">Google rated by 500+ travelers</p>
          </div>
