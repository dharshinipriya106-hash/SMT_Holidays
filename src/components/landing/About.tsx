      ...
      <div className="container-pg grid lg:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <p className="mt-5 text-muted-foreground text-base md:text-lg leading-relaxed">
            SMT Holidays provides family tour packages, temple tours, honeymoon packages, group
            tours, corporate tours and customized holiday experiences across South India. We focus
            on comfort, safety and memorable travel experiences — every journey planned with care
            from Sankarankovil.
          </p>
