            ...
            <>
              ...
              <div className="p-6">
                ...
                <DialogFooter className="mt-5 flex-col sm:flex-row gap-2">
                  <Button asChild variant="outline" className="border-whatsapp text-foreground">
                    <a
                      href={waUrl(
                        `Hi! I'm interested in the ${active.name}. Please share details.`,
                      )}
                      target="_blank"
