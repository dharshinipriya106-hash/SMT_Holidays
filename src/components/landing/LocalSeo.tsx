    ...
    <section className="section-pad bg-surface">
      <div className="container-pg max-w-4xl">
        ...
        <p className="mt-5 text-muted-foreground leading-relaxed text-center">
          SMT Holidays offers affordable family tours, temple tours, honeymoon packages and
          customized holiday trips from Sankarankovil, Tirunelveli, Tenkasi and surrounding regions.
          From short weekend getaways to full-circuit South India temple tours, we make planning
          simple and travel memorable for every kind of traveler.
        </p>
